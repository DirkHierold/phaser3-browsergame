...
export default class EasyGameScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Score
    this.localHighscore = DataHandler.easyLocalHighscore;
    this.globalHighscore = DataHandler.easyGlobalHighscore;
    this.leader = DataHandler.easyHighscoreName;
